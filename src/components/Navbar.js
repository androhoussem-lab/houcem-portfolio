...
const Navbar = (props)=>{
    return (
        ...
        className="z-50 bg-mirage w-full py-4 px-4 md:px-8 flex  justify-between items-center fixed md:relative">
            <a className="font-dancing font-black text-2xl text-purple md:text-4xl" href='https://androhoussem-lab.github.io/houcem-portfolio/'><h1>Houcem<span className="text-rose">Portfolio</span></h1></a>
