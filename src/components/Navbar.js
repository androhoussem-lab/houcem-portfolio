...
const Navbar = (props)=>{
    return (
        ...
        className="z-50 bg-mirage w-full py-4 px-4 md:px-8 flex  justify-between items-center fixed md:relative">
            <a className="font-dancing  text-purple text-2xl md:text-3xl lg:text-4xl font-bold" href='https://androhoussem-lab.github.io/houcem-portfolio/'><h1>Houcem<span className="text-rose">Portfolio</span></h1></a>
